...
class LanguageModel(object):
    ...
    def glue_tokens(self, tokens):
        """The standard way in which we glue together tokens /home/student/deep_disfluency-master/deep_disfluency/feature_extraction/crf_pos_tagger_example.pyto create keys
        in our hashmaps"""
        return ' '.join(tokens)
