    ...
    def tag_new_word(self, word, pos=None, timing=None, extra=None,
        ...
        if diff_only:
            for i, old_new in enumerate(zip(prev_output_tags,
                ...
                old, new = old_new
                if old != new:
                    return self.output_tags[i:], self.tag_to_index_map, softmax
            return self.output_tags[len(prev_output_tags):], self.tag_to_index_map, softmax
        return self.output_tags, self.tag_to_index_map, softmax
