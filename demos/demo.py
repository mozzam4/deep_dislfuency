...
if with_pos:
    ...
    print disf.tag_new_word("Jan", pos="NNP")
    print disf.tag_new_word("and", pos="CC")
    print disf.tag_new_word("Neil", pos="NNP")
    print disf.tag_new_word("um", pos="NNP")
    print disf.tag_new_word("Meil", pos="NNP")
    print disf.tag_new_word("are", pos="VBP")
    print disf.tag_new_word("friends", pos="NNS")
else:
    # else the internal POS tagger tags the words incrementally
    print disf.tag_new_word("Jan")
    print disf.tag_new_word("and")
    print disf.tag_new_word("Neil")
    print disf.tag_new_word("um")
    print disf.tag_new_word("Meil")
    print disf.tag_new_word("are")
    print disf.tag_new_word("friends")
print "final tags:"
for w, t in zip("mmm may be I can do this but I am not sure maybe".split(), disf.output_tags):
    print w, "\t", t
